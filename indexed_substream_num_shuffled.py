################################################################### SYNOPSIS
#
# exctract num indexed chunks from CrystFEL .stream file into a new .stream file while shuffling the chunks from the original .stream file
#
################################################################### AUTHOR/REPOSITORY
#
# agorel@mr.mpg.de
...
################################################################### USAGE
#
# python3 indexed_substream_num_shuffled.py -s something.stream -o something-num.stream -n 100
#
################################################################### IMPORTS
...
#    chunk_list=chunk_list[:number]
    chunk_list=random.sample(chunk_list,number)
print("cut list.")
#---------------------------------------------------- WRITE TEXT
